  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <img
          src="https://i.pinimg.com/736x/13/75/0a/13750a06a59388703fe345b2cb22c0d3.jpg"
          alt="Luxury perfume"
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-lg text-white/90 max-w-xl opacity-0 animate-fade-in animate-delay-300">
            Explore our curated collection of premium fragrances designed to
            captivate the senses and leave a lasting impression.
          </p>
